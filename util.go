...
func fillNumber(str, where string, n int) string {
	...
	case "pre":
		for i := 0; i < n; i++ {
			str = string(Number[randomN(len(Number))]) + str
		}
	case "inner":
		for i := 0; i < n; i++ {
			strs += string(Number[randomN(len(Number))])
		}
		l := randomN(len(str))
		str = str[:l] + strs + str[len(str)-l:]
	case "post":
		for i := 0; i < n; i++ {
			str += string(Number[randomN(len(Number))])
		}
	}
...
func fillSpechar(str, where string, n int) string {
	...
	case "pre":
		for i := 0; i < n; i++ {
			str = string(Spechar[randomN(len(Spechar))]) + str
		}
	case "inner":
		for i := 0; i < n; i++ {
			strs += string(Spechar[randomN(len(Spechar))])
		}
		l := randomN(len(str))
		str = str[:l] + strs + str[len(str)-l:]
	case "post":
		for i := 0; i < n; i++ {
			str += string(Spechar[randomN(len(Spechar))])
		}
	}
...
func fillLetter(str, where string, n int) string {
	...
	case "pre":
		for i := 0; i < n; i++ {
			str = string(Alphabet[randomN(len(Alphabet))]) + str
		}
	case "inner":
		for i := 0; i < n; i++ {
			strs += string(Alphabet[randomN(len(Alphabet))])
		}
		l := randomN(len(str))
		str = str[:l] + strs + str[len(str)-l:]
	case "post":
		for i := 0; i < n; i++ {
			str += string(Alphabet[randomN(len(Alphabet))])
		}
	}
